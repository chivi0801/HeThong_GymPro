...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        /* Active Nav Item - Quản lý hội viên */
        ...
        /* Đã được sửa lại giống hệt file DoanhThu.php */
        .main-content { 
            flex: 1; 
            display: flex; 
            flex-direction: column; 
            overflow: hidden; /* Khóa cuộn ở đây để Header đứng im */
        }
        ...
        .page-content {
            ...
            display: flex; 
            flex-direction: column; 
            overflow-y: auto; /* Chỉ phần này được phép cuộn */
            padding: 24px 40px;
        }

        /* ================= PAGE TITLE & EXPORT (Kiểu giống Doanh Thu) ================= */
